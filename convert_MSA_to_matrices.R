...
alnmnt<-read.alignment("~/xylose_optimization_project/data/orthologs/cds/xyl3_cds_MSA.fsa", format="fasta")
#also reading in fasta
fs<- read.fasta("~/xylose_optimization_project/data/orthologs/cds/xyl3_cds_MSA.fsa")
