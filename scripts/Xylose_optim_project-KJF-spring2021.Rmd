...
```{r}
par(mfrow=c(3,3))
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="spathaspora passalidarum")], xlab="tAI values", main="Spath.passalidarum tAI distribution", col="darkolivegreen1")
...
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="spathaspora gorwiae")], xlab="tAI values", main="Spath.gorwiae tAI distribution", col="darkolivegreen1")
...
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="scheffersomyces stipitis")], xlab="tAI values", main="Sch.stipitis tAI distribution", col="darkolivegreen1")
...
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="lipomyces doorenjongii")], xlab="tAI values", main="Lip.doorenjongii tAI distribution", col="darkolivegreen1")
...
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="spathaspora arborariae")], xlab="tAI values", main="Spath.arborariae tAI distribution", col="darkolivegreen1")
...
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="spathaspora girioi")], xlab="tAI values", main="Spath.girioi tAI distribution", col="darkolivegreen1")
...
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="spathaspora hagerdaliae")], xlab="tAI values", main="Spath.hagerdaliae tAI distribution", col="darkolivegreen1")
...
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="ogataea nitratoaversa")], xlab="tAI values", main="Og.nitratoaversa tAI distribution", col="darkolivegreen1")
...
hist(genome_wide_tAI$V2[which(genome_wide_tAI$taxa=="scheffersomyces lignosus")], xlab="tAI values", main="Sch.lignosus tAI distribution", col="darkolivegreen1")
